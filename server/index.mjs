...
app.post("/api/auth", async (req, res) => {
  // https://workshopnuxtjs-default-rtdb.asia-southeast1.firebasedatabase.app
  // https://living-mobile-demo-default-rtdb.asia-southeast1.firebasedatabase.app
...
app.get("/api/users/", async (req, res) => {
  let offest = (req.query.page - 1) * req.query.size || 0;
